...
<app:service xmlns:app="http://www.w3.org/2007/app" xmlns:atom="http://www.w3.org/2005/Atom">
  ...
  <app:workspace>
	...
	if accepts[0] != "application/vnd.sap.adt.packages.v2+xml" {
		t.Errorf("first accept: got %q", accepts[0])
	}
	if accepts[1] != "application/vnd.sap.adt.packages.v1+xml" {
...
func TestNegotiateContentType(t *testing.T) {
	...
	got := c.NegotiateContentType("/sap/bc/adt/packages",
		[]string{"application/vnd.sap.adt.packages.v2+xml", "application/vnd.sap.adt.packages.v1+xml"},
		"application/xml")
	if got != "application/vnd.sap.adt.packages.v2+xml" {
	...
	got = c.NegotiateContentType("/sap/bc/adt/packages",
		[]string{"application/vnd.sap.adt.packages.v3+xml", "application/vnd.sap.adt.packages.v2+xml"},
		"application/xml")
	if got != "application/vnd.sap.adt.packages.v2+xml" {
